...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (mysqli_num_rows($checkResult) > 0) {
        ...
        if (move_uploaded_file($_FILES['bukti_bayar']['tmp_name'], $uploadFile)) {
            ...
            if ($result) {
                $successMessage = "Selamat! Anda telah melakukan pembayaran iuran, silakan cek status pembayaran iuran Anda di menu riwayat iuran.";
            } else {
